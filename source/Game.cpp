...
void Game::Init()
{
	...
	AM->LoadSoundData("resources/455911__bolkmar__machine-gun-shoot-only.wav");
	AM->LoadSoundData("resources/138481__justinvoke__bullet-blood-4.wav");
	AM->LoadSoundData("resources/270333__littlerobotsoundfactory__jingle_win_00.wav");
	AM->LoadSoundData("resources/414209__jacksonacademyashmore__death.wav");
	AM->LoadSoundData("resources/501104__evretro__8-bit-damage-sound.wav");
	AM->LoadSoundData("resources/538151__fupicat__8bit-fall.wav");
	AM->LoadSoundData("resources/450616__breviceps__8-bit-error.wav");
