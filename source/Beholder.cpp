...
Beholder::Beholder(Vector2 spawnPosition)
    : Enemy()
{
    _renderer = new ImageRenderer(_transform, "resources/images/beholder.png", Vector2(0.f, 0.f), Vector2(100.f, 100.f));
...
Vector2 Beholder::GetLeftDirection()
{
    return Vector2(-1.0f, 0.0f);
}

Vector2 Beholder::GetDirectionToPlayer()
{
...
void Beholder::OnCollisionEnter(Object* object)
{
